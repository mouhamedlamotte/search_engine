...
SECRET_KEY = 'django-insecure-_kw8ub8^h-0r9aj*zc=ib^71@(a!$$ey7ip4u^h%ojq9la8roo'
...
ELASTICSEARCH_DSL={
    'default': {
        'hosts': 'https://6d5bb9c71f364bf9a7151a2b9ace31b5.us-central1.gcp.cloud.es.io/',
        'http_auth': ('elastic', 'JinCIJn1nxrpg0a5oZZMwXAc'),
        'verify_certs': False,
    }
}
